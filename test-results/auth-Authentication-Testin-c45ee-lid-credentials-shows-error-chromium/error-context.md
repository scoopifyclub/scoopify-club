...
- Name: Authentication Testing >> Login with invalid credentials shows error
- Location: C:\Users\matt2\Documents\Cursor\ScoopifyClub\tests\auth.spec.js:26:3
...
Call log:
  ...
  - waiting for locator('text=Invalid email or password')
    ...
    at C:\Users\matt2\Documents\Cursor\ScoopifyClub\tests\auth.spec.js:35:66
```
