 ...
 */
export async function calculateServiceEarnings(subscriptionId: string): Promise<number> {
 ...
 */
export async function createWeeklyServices(subscriptionId: string, startDate: Date, endDate: Date) {
 ...
 */
export async function approveServicePayment(serviceId: string, adminUserId: string) {
