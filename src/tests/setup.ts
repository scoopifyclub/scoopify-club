...
export async function setupTestDatabase() {
  try {
    ...
    execSync('npx prisma db push --accept-data-loss --force-reset', { stdio: 'inherit', env: { ...process.env, DATABASE_URL: process.env.DATABASE_URL } });
...
export async function createTestUser(role: 'CUSTOMER' | 'EMPLOYEE' | 'ADMIN') {
