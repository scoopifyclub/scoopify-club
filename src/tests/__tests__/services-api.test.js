...
describe('Services API Routes', () => {
    ...
    describe('POST /api/services', () => {
        it('should create a new service for a valid customer request', async () => {
            ...
            prisma.servicePlan.findUnique.mockResolvedValue(mockServicePlan);
            prisma.service.create.mockResolvedValue(mockService);
            sendServiceNotificationEmail.mockResolvedValue(undefined);
            // Create the request
    ...
    describe('GET /api/services', () => {
        it('should return services filtered by date range and user role', async () => {
            ...
            // Create the request
            const request = new NextRequest('http://localhost:3000/api/services?startDate=2023-07-01&endDate=2023-07-03', { method: 'GET' });
            // Call the handler
        ...
        it('should return 400 if date range parameters are missing', async () => {
            ...
            const request = new NextRequest('http://localhost:3000/api/services', { method: 'GET' });
            // Call the handler
            const response = await GET(request);
            const responseData = await response.json();
            // Assertions
