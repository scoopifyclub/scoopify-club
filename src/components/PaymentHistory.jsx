...
/**
 * PaymentHistory component for displaying payment history
            ...
            <tbody>
              {payments.map((payment) => (<tr key={payment.id} className="border-b">
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${payment.status === 'SUCCEEDED'
