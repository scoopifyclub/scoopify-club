...
export function ServiceMap({ services, onServiceClick }) {
    ...
    return (<div className="h-[500px] w-full rounded-lg overflow-hidden">
      <MapContainer center={center} zoom={zoom} style={{ height: '100%', width: '100%' }}>
        ...
        {services.map((service) => {
            if (!service.latitude || !service.longitude)
                return null;
            return (<Marker key={service.id} position={[service.latitude, service.longitude]} icon={icon} eventHandlers={{
              ...
              <Popup>
                <div className="space-y-2">
                  ...
                  {service.customer.address && (<div className="text-sm">
