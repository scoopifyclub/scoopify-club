        ...
        <CardContent>
          <Table>
            ...
            return (<TableRow key={referral.id}>
                  ...
                  <TableCell>
                    <Badge variant={referral.status === 'COMPLETED'
                    ? 'default'
                  ...
                  <TableCell>
                    {referral.reward ? (<div>
                        ...
                        <Badge variant={referral.reward.status === 'PAID'
                        ? 'default'
                        : 'secondary'}>
                  ...
                  <TableCell>
                    {((_a = referral.reward) === null || _a === void 0 ? void 0 : _a.status) === 'PENDING' && (<div className="flex items-center space-x-2">
                        <Input placeholder="Cash App Transaction ID" className="w-48" id={`transaction-${referral.reward.id}`}/>
                        <Button size="sm" onClick={() => handleMarkAsPaid(referral.reward.id, document.getElementById(`transaction-${referral.reward.id}`).value)} disabled={processingId === referral.reward.id}>
                          Mark as Paid
                        </Button>
                      </div>)}
                  </TableCell>
