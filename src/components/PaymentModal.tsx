...
interface PaymentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (amount: number, cashAppPaymentId: string) => Promise<void>;
  referral: {
    referrer: {
      name: string;
...
export default function PaymentModal({ isOpen, onClose, onSubmit, referral }: PaymentModalProps) {
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        ...
                        {referral.referrer.cashAppTag && (
                          <span className="block">Cash App: ${referral.referrer.cashAppTag}</span>
                        )}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <input
                        type="text"
                        id="cashAppPaymentId"
                        value={cashAppPaymentId}
                        onChange={(e) => setCashAppPaymentId(e.target.value)}
                        className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                        required
                      />
                    </div>
