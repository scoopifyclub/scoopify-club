      ...
      <div className="grid gap-6">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[...Array(4)].map((_, i) => (
                  ...
                  >
                    {photos[i + 4] ? (
                      <img
                        src={URL.createObjectURL(photos[i + 4])}
                        alt={`After corner ${i + 1}`}
                        className="max-w-full h-auto"
                      />
                    ) : (
                      <Camera className="w-8 h-8 text-gray-400" />
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Checkbox
                id="gateClosedOnEntry"
                checked={checklist.gateClosedOnEntry}
                onCheckedChange={() => handleChecklistChange('gateClosedOnEntry')}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                id="yardCleaned"
                checked={checklist.yardCleaned}
                onCheckedChange={() => handleChecklistChange('yardCleaned')}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                id="gateClosedOnExit"
                checked={checklist.gateClosedOnExit}
                onCheckedChange={() => handleChecklistChange('gateClosedOnExit')}
              />
        ...
        <div className="flex justify-end">
          <Button
            ...
            disabled={!checklist.gateClosedOnEntry || !checklist.yardCleaned || !checklist.gateClosedOnExit || photos.length !== 8}
          >
            Complete Service
          </Button>
        </div>
