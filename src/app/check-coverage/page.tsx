...
export default function CheckCoverage() {
  ...
  const checkServiceArea = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    setError('');
        ...
        <form onSubmit={checkServiceArea} className="mt-8 space-y-6">
          <div>
            ...
            <input
              ...
              type="text"
              required
              className="relative block w-full rounded-md border-0 py-3 px-4 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-600 sm:text-sm sm:leading-6"
