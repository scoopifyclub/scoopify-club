...
export default function CareersPage() {
    return (<div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
      <Navbar />
      <main>
        {/* Hero Section */}
        ...
        ].map((req) => (<li key={req} className="flex items-start">
        ...
        ].map((item) => (<li key={item} className="flex items-start">
                        <Check className="h-5 w-5 flex-shrink-0 text-brand-primary"/>
        ...
        ].map((value) => (<div key={value.title} className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-neutral-200">
