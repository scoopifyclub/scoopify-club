...
export default function ServicesPage() {
    return (<div className="min-h-screen bg-neutral-50">
      <main>
          ...
          <div className="container mx-auto px-4">
            ...
            'No contracts - pause or cancel anytime',
        ].map((feature) => (<li key={feature} className="flex items-start gap-3">
              ...
              <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-xl">
                <Image src="https://images.unsplash.com/photo-1585071550721-fdb362ae2b8d?q=80&w=2070&auto=format&fit=crop" alt="Professional dog waste removal service" fill className="object-cover"/>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="rounded-2xl bg-gradient-to-br from-primary to-primary-dark px-6 py-16 sm:p-16">
              <div className="max-w-2xl mx-auto text-center text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/pricing">
                    <Button className="bg-white text-primary hover:bg-white/90 text-lg w-full sm:w-auto">
                      View Subscription Plans
                    </Button>
                  </Link>
                  <Link href="/signup">
                    <Button variant="outline" className="border-white text-white hover:bg-white/10 text-lg w-full sm:w-auto">
                      Sign Up Now
                    </Button>
                  </Link>
                </div>
