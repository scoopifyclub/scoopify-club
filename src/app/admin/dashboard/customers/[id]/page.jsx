    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            setCustomer(prev => {
                if (!prev)
                    return null;
                return Object.assign(Object.assign({}, prev), { name: editFormData.name, email: editFormData.email, phone: editFormData.phone, address: editFormData.address });
            });
    ...
    return (<div className="p-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div className="flex gap-2">
          ...
          {customer.status === 'active' ? (<Button variant="destructive" onClick={() => setIsDeactivateDialogOpen(true)}>
              Deactivate
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            {customer.paymentMethods && customer.paymentMethods.length > 0 ? (<div className="space-y-4">
                {customer.paymentMethods.map(payment => (<div key={payment.id} className="flex items-center justify-between p-3 border rounded-md">
                    <div className="flex items-center">
                    ...
                    {payment.isDefault && (<Badge variant="secondary">Default</Badge>)}
                  </div>))}
      ...
      <Tabs defaultValue="services" className="w-full">
        ...
        <TabsContent value="services" className="mt-6">
          <Card>
            ...
            <CardContent>
              {customer.serviceHistory && customer.serviceHistory.length > 0 ? (<div className="rounded-md border">
                  <table className="w-full caption-bottom text-sm">
                    ...
                    <tbody className="[&_tr:last-child]:border-0">
                      {customer.serviceHistory.map((service) => (<tr key={service.id} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted cursor-pointer" onClick={() => router.push(`/admin/dashboard/services/${service.id}`)}>
                          ...
                          <td className="p-4 align-middle">
                            <Badge className={service.status === 'completed' ? 'bg-green-100 text-green-800' :
        ...
        <TabsContent value="upcoming" className="mt-6">
          <Card>
            ...
            <CardContent>
              {customer.upcomingServices && customer.upcomingServices.length > 0 ? (<div className="space-y-4">
                  {customer.upcomingServices.map(service => (<div key={service.id} className="p-4 border rounded-md">
                  ...
                  <Button variant="outline" className="mt-4" onClick={() => router.push(`/admin/dashboard/services/schedule?customer=${customer.id}`)}>
                    Schedule Service
                  </Button>
                </div>)}
            </CardContent>
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="address" value={editFormData.address} onChange={(e) => setEditFormData(Object.assign(Object.assign({}, editFormData), { address: e.target.value }))}/>
            </div>
          </div>
          <DialogFooter>
