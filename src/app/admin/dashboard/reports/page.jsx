...
export default function ReportsPage() {
    ...
    const renderBarChart = (data, valueKey) => {
        ...
        {data.map((item, index) => (<div key={index} className="mb-2">
            ...
            <div className="w-full bg-muted rounded-full h-2">
              <div className="bg-primary rounded-full h-2" style={{ width: `${(item[valueKey] / maxValue) * 100}%` }}></div>
            </div>
          </div>))}
      </div>);
    };
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-2">
          <div className="relative w-[180px]">
            <select className="w-full h-10 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" value={dateRange} onChange={(e) => setDateRange(e.target.value)}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <CardContent>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-muted rounded-full h-2">
                  <div className="bg-green-500 rounded-full h-2" style={{ width: `${reportData.customers.retention}%` }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-1">
                ...
                <div className="w-full bg-muted rounded-full h-2">
                  <div className="bg-blue-500 rounded-full h-2" style={{ width: `${reportData.customers.satisfaction}%` }}></div>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="space-y-4">
              {reportData.employees.performance.map((employee, index) => (<div key={index} className="flex items-center justify-between">
