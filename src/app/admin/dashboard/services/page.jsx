        ...
        if (searchQuery) {
            ...
            filtered = filtered.filter(service => {
                ...
                return service.customer.name.toLowerCase().includes(query) ||
                    ...
                    (((_a = service.employee) === null || _a === void 0 ? void 0 : _a.name.toLowerCase().includes(query)) || false);
            });
        }
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="relative w-full md:w-64">
              ...
              <Input placeholder="Search services..." className="pl-8" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
            </div>
            
            <select className="w-full md:w-48 h-10 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)}>
            ...
            <div className="relative w-full overflow-auto">
              <table className="w-full caption-bottom text-sm">
                ...
                <tbody className="[&_tr:last-child]:border-0">
                  {filteredServices.map((service) => (<tr key={service.id} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted cursor-pointer" onClick={() => handleViewService(service.id)}>
