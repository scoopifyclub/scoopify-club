...
import { ArrowLeft, AlertCircle, DollarSign, Clock, Sparkles, Info } from 'lucide-react';
...
export default function AdjustServicePage() {
  ...
  const [additionalServicesTotal, setAdditionalServicesTotal] = useState<number>(0);
                ...
                <div className="flex justify-between">
                  ...
                  <Badge 
                    className={cn(
                      ...
                      service.status === 'in-progress' && "bg-orange-500",
                      service.status === 'completed' && "bg-green-500",
                      service.status === 'cancelled' && "bg-gray-500"
                    )}
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="price-adjustment"
                    type="number"
                    step={priceAdjustmentType === 'fixed' ? '0.01' : '0.1'}
                    placeholder={priceAdjustmentType === 'fixed' ? "0.00" : "0.0"}
                    className="pl-8"
