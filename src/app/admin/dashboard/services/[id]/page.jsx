...
export default function ServiceDetailsPage() {
    ...
    const fetchServiceDetails = async () => {
        ...
        try {
            ...
            setSelectedEmployee(((_a = mockService.employee) === null || _a === void 0 ? void 0 : _a.id) || '');
    ...
    const handleUpdateService = async () => {
        ...
        try {
            ...
            setService(prev => {
                if (!prev)
                    return null;
                return Object.assign(Object.assign({}, prev), { notes: updateNotes, employee: selectedEmployee
    ...
    const handleCancelService = async () => {
        ...
        try {
            ...
            setService(prev => {
                if (!prev)
                    return null;
                return Object.assign(Object.assign({}, prev), { status: 'cancelled' });
            });
            toast({
    ...
    const handleCompleteService = async () => {
        ...
        try {
            ...
            setService(prev => {
                if (!prev)
                    return null;
                return Object.assign(Object.assign({}, prev), { status: 'completed' });
            });
            toast({
    ...
    return (<div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="sm" onClick={() => router.push('/admin/dashboard/services')}>
        ...
        <div className="flex gap-2">
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4 py-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="notes" value={updateNotes} onChange={(e) => setUpdateNotes(e.target.value)} rows={4}/>
                    </div>
                  </div>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={handleCancelService} disabled={isSubmitting} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
          ...
          {service.status === 'in-progress' && (<Button onClick={handleCompleteService} disabled={isSubmitting}>
              {isSubmitting ? (<>
                  <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>
                  Processing...
                </>) : 'Mark as Completed'}
          ...
          {service.status === 'scheduled' && (<Button onClick={() => router.push(`/admin/dashboard/services/${serviceId}/reschedule`)}>
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
        <Card>
          ...
          {service.serviceType.description && (<CardFooter className="text-sm text-muted-foreground border-t pt-4">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardFooter>
              <Button variant="outline" className="w-full" onClick={() => router.push(`/admin/dashboard/customers/${service.customer.id}`)}>
          ...
          <Card>
            ...
            <CardContent>
              {service.employee ? (<div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <p className="text-sm font-medium flex items-center">
                      <User className="h-4 w-4 mr-1 text-muted-foreground"/>
                      Name
                  ...
                  <Button variant="outline" className="mt-2" onClick={() => setIsDialogOpen(true)} disabled={service.status !== 'scheduled'}>
                    Assign Employee
                  </Button>
                </div>)}
            </CardContent>
            {service.employee && (<CardFooter>
                <Button variant="outline" className="w-full" onClick={() => { var _a; return router.push(`/admin/dashboard/employees/${(_a = service.employee) === null || _a === void 0 ? void 0 : _a.id}`); }}>
