...
export default function EmployeesPage() {
    ...
    useEffect(() => {
        ...
        if (searchQuery) {
            ...
            const filtered = employees.filter(employee => employee.name.toLowerCase().includes(query) ||
    ...
    return (<div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button onClick={() => router.push('/admin/dashboard/employees/add')} className="whitespace-nowrap">
            ...
            <div className="relative w-full overflow-auto">
              <table className="w-full caption-bottom text-sm">
                ...
                <tbody className="[&_tr:last-child]:border-0">
                  {filteredEmployees.map((employee) => (<tr key={employee.id} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted cursor-pointer" onClick={() => handleViewEmployee(employee.id)}>
