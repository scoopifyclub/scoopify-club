          ...
          <div className="bg-white shadow rounded-lg p-6 mb-6">
            ...
            <form onSubmit={handleAddEmployee} className="space-y-4">
              ...
              <div>
                ...
                {formData.serviceAreas.map((zipCode, index) => (
                  <div key={index} className="flex gap-2 mb-2">
                    ...
                    />
                    {index === formData.serviceAreas.length - 1 && (
                      <Button
                        type="button"
                        onClick={() => setFormData({
                          ...formData,
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg p-6 max-w-md w-full">
              ...
              <form onSubmit={handleEditEmployee} className="space-y-4">
                ...
                <div>
                  <Label>Service Areas (Zip Codes)</Label>
                  {editFormData.serviceAreas?.map((zipCode, index) => (
                    <div key={index} className="flex gap-2 mb-2">
                      <Input
                        value={zipCode}
                        onChange={(e) => {
                          ...
                          newAreas[index] = e.target.value;
                          setEditFormData({ ...editFormData, serviceAreas: newAreas });
                        }}
                        placeholder="Enter zip code"
                      />
                      <Button
            ...
            <ul className="divide-y divide-gray-200">
              {filteredEmployees.map((employee) => (
                <li key={employee.id} className="p-6">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="text-sm text-gray-600">
                        <p>Rating: {employee.rating?.toFixed(1) || 'N/A'}/5</p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="text-sm text-gray-600">
                        {employee.serviceAreas.map((zipCode, index) => (
                  ...
                  {/* Upcoming Services */}
                  {employee.upcomingServices.length > 0 && (
                    <div className="mt-4">
