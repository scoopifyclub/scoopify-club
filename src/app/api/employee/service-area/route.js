...
export async function POST(request) {
  ...
  try {
    ...
    // Create new service area using CoverageArea model
    const serviceArea = await prisma.coverageArea.create({
      data: {
        employeeId: employee.id,
        zipCode,
        travelDistance: travelRange,
        active: true
      }
    });

    // Update employee's hasSetServiceArea flag
...
export async function PUT(request) {
  ...
  try {
    ...
    // Update service area using CoverageArea model
    const serviceArea = await prisma.coverageArea.update({
      where: { id },
      data: {
        zipCode,
        travelDistance: travelRange,
...
export async function DELETE(request) {
  ...
  try {
    ...
    // Delete service area using CoverageArea model
