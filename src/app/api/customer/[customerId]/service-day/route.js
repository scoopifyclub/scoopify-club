...
export async function PUT(request, { params }) {
    ...
    try {
        ...
        if (!validDays.includes(serviceDay)) {
            return NextResponse.json({ error: 'Invalid service day. Must be a valid day of the week.' }, { status: 400 });
        }
        ...
        return NextResponse.json({ error: 'Failed to update service day' }, { status: 500 });
    }
}
export async function GET(request, { params }) {
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to get service day' }, { status: 500 });
    }
}
