...
export default function ServiceHistoryPage() {
    ...
    const renderThankYouSection = (completedServices) => {
        if (completedServices.length === 0)
            return null;
        return (<div className="bg-green-50 rounded-lg p-6 mb-8 border border-green-100">
    ...
    return (<div className="container mx-auto py-8">
      ...
      <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="upcoming">
          {upcomingServices.length === 0 ? (<div className="text-center py-12">
              ...
              {Object.entries(upcomingByDate).map(([date, services]) => (<div key={date}>
                    ...
                    {services.map(service => (<Card key={service.id} className="overflow-hidden">
                        ...
                        <CardContent>
                          <div className="space-y-2">
                            ...
                            {service.employee && (<div className="flex items-center">
        ...
        <TabsContent value="completed">
          {completedServices.length === 0 ? (<div className="text-center py-12">
              ...
              {Object.entries(completedByMonth).map(([date, services]) => (<div key={date}>
                  <h3 className="text-xl font-semibold mb-4">{date}</h3>
                    ...
                    {services.map(service => (<Card key={service.id} className="overflow-hidden">
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            ...
                            {service.notes && (<div className="bg-gray-50 p-3 rounded-md">
                                <p className="text-sm font-medium mb-1">Notes:</p>
                                <p className="text-sm">{service.notes}</p>
                              </div>)}
                            
                            {/* Service Photos */}
                            {service.photos && service.photos.length > 0 && (<div className="mt-4">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                  {service.photos.map(photo => !isPhotoExpired(photo) && (<Dialog key={photo.id}>
                                ...
                                {service.photos.every(photo => isPhotoExpired(photo)) && (<p className="text-sm text-gray-500 mt-2">
        ...
        <TabsContent value="cancelled">
          {cancelledServices.length === 0 ? (<div className="text-center py-12">
              ...
              {cancelledServices.map(service => (<Card key={service.id}>
                  <CardHeader className="pb-2">
                    <div className="flex justify-between items-center">
                      <CardTitle className="text-lg">
                        {format(new Date(service.scheduledDate), 'EEEE, MMMM d')}
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      {service.notes && (<div className="bg-gray-50 p-3 rounded-md mt-2">
