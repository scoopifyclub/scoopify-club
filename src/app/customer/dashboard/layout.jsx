      ...
      <div className="flex gap-8">
        ...
        <aside className="w-72 bg-white rounded-2xl shadow-lg p-6 h-fit border border-gray-100">
          ...
          <nav className="space-y-2">
            ...
            <button onClick={() => router.push('/customer/dashboard/referrals')} className={`w-full flex items-center px-4 py-3 rounded-xl transition-colors ${pathname.includes('/referrals')
            ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-white'
            : 'text-gray-700 hover:bg-blue-50'}`}>
            ...
            <button onClick={handleLogout} className="w-full flex items-center px-4 py-3 rounded-xl transition-colors text-red-600 hover:bg-red-50" data-testid="logout-button">
