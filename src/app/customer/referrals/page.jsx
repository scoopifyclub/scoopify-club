...
import { UserPlusIcon, CurrencyDollarIcon, ClipboardIcon, CheckIcon, UserGroupIcon } from '@heroicons/react/24/outline';
...
export default function ReferralsPage() {
    ...
    const handleCopyReferralCode = () => {
        if (stats === null || stats === void 0 ? void 0 : stats.referralCode) {
    ...
    const handleUpdateCashApp = async () => {
        ...
        try {
            ...
            if (!response.ok)
                throw new Error('Failed to update Cash App tag');
          ...
          <div className="flex items-center space-x-4">
            <div className="flex-1 bg-gray-50 rounded-lg p-4">
              <p className="text-2xl font-mono font-bold text-gray-700">
                {stats === null || stats === void 0 ? void 0 : stats.referralCode}
              </p>
            </div>
            <button onClick={handleCopyReferralCode} className="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-1 flex rounded-md shadow-sm">
                ...
                <input type="text" value={cashAppTag} onChange={(e) => setCashAppTag(e.target.value)} placeholder="YourCashAppTag" className="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:ring-blue-500 focus:border-blue-500"/>
              </div>
            </div>
            <button onClick={handleUpdateCashApp} disabled={updating || !cashAppTag} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-2xl font-semibold text-gray-900">
                      {stats === null || stats === void 0 ? void 0 : stats.stats.activeReferrals}
                    </dd>
                  </dl>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-2xl font-semibold text-gray-900">
                      {stats === null || stats === void 0 ? void 0 : stats.stats.pendingReferrals}
                    </dd>
                  </dl>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-2xl font-semibold text-gray-900">
                      {formatCurrency((stats === null || stats === void 0 ? void 0 : stats.stats.totalEarned) || 0)}
                    </dd>
                  </dl>
                </div>
              </div>
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="border-t border-gray-200">
            <ul className="divide-y divide-gray-200">
              {(stats === null || stats === void 0 ? void 0 : stats.referrals.length) === 0 ? (<li className="px-4 py-5 sm:px-6 text-center text-gray-500">
                  No referrals yet. Share your code to start earning!
                </li>) : (stats === null || stats === void 0 ? void 0 : stats.referrals.map((referral) => (<li key={referral.id} className="px-4 py-5 sm:px-6">
